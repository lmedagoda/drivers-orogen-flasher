...
tasks/Task.cpp, and will be put in the flasher namespace.
     * \details
     * The name of a TaskContext is primarily defined via:
     \verbatim
     deployment 'deployment_name'
         task('custom_task_name','flasher::Task')
     end
     \endverbatim
    ...
    public:
         ...
         */
        Task(std::string const& name = "flasher::Task");
